                    ...
                    <div className="type-of-skill">
                      <div className="type-of-skill-name">
                        <div className="extra-skill-cat-wrapper">
                          ...
                          <svg className="deployment-sticker" width="100px" height="100px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="type-of-skill-name">
                        <div className="extra-skill-cat-wrapper">
                          <svg width="100px" height="100px" viewBox="0 0 64 64" fill="none" stroke="#ffffff"><path d="M56 16v32c0 4.42-10.75 8-24 8S8 52.42 8 48V16c0-4.42 10.75-8 24-8s24 3.58 24 8z" /><path d="M56 16c0 4.42-10.75 8-24 8S8 20.42 8 16" /><path d="M56 32c0 4.42-10.75 8-24 8S8 36.42 8 32" /></svg>
                        </div>
